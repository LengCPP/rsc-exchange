...
export type CommunitiesReadCommunityLoansData = {
    id: string;
    limit?: number;
    skip?: number;
};

export type CommunitiesReadCommunityLoansResponse = (LoansPublic);
...
export type LoginLoginGoogleInitResponse = (unknown);

export type LoginLoginGoogleCallbackData = {
    code: string;
};

export type LoginLoginGoogleCallbackResponse = (unknown);
